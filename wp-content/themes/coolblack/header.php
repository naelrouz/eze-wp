...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
    ...
    <meta name="description"
          content="日本人の繊細さにアダルト、セクシーを掛け合わせたブラックモードスタイルを提案するアパレルブランド「SHOKI JOETAKI」。公式サイトでは、最新のコレクションやニュース、ブログ、取り扱い店舗情報等を掲載しています。">
    ...
    <!-- js -->
    <script charset="utf-8" src="<?php bloginfo('template_url'); ?>/js/jquery.js"></script>
    <script charset="utf-8" src="<?php bloginfo('template_url'); ?>/js/main.js"></script>
...
<noscript class="no-script">This site does not appear normal and not in the JavaScript is enabled state. If this message
    is displayed, please check the setting of the browser.
</noscript>

<!--[if lt IE 10]>
<!--<div class="under-ie9">-->
    <!--<div class="under-ie9__inner">-->
        <!--<h1 class="under-ie9__title"><img-->
            <!--src="http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/images/sj-logo-w.svg"-->
            <!--alt="SHOKI JOETAKI"/></h1>-->
        <!--<p>Excuse me, but your browser (software for Internet browsing) does not support the old version this Web site-->
            <!--for.</p>-->
        <!--<p>In older versions of the browser, making it a non-display because there may not be displayed properly.<a-->
            <!--href="http://browsehappy.com/">Update to the latest version</a>Learn from you.</p>-->
    <!--</div>-->
<!--</div>-->
<![endif]-->
