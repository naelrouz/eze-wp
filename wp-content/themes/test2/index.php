...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
	...
	<!-- css -->
	<link rel="stylesheet" href="http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/css/style.css" media="all">
	...
	<meta property="og:title" content="SHOKI JOETAKI OFFICIAL &#8211; 日本人の繊細さにアダルト、セクシーを掛け合わせたブラックモードスタイルを提案するアパレルブランド「SHOKI JOETAKI」。公式サイトでは、最新のコレクションやニュース、ブログ、取り扱い店舗情報等を掲載しています。">
	<meta property="og:type" content="website">
	<meta property="og:url" content="http://shokijoetaki.com/">
	<meta property="og:image" content="http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/images/common/sj-eyecatch-default.jpg">
	<meta property="og:site_name" content="SHOKI JOETAKI OFFICIAL">
	<meta property="og:description" content="日本人の繊細さにアダルト、セクシーを掛け合わせたブラックモードスタイルを提案するアパレルブランド「SHOKI JOETAKI」。公式サイトでは、最新のコレクションやニュース、ブログ、取り扱い店舗情報等を掲載しています。">

	<!-- js -->
	<script charset="utf-8" src="http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/js/library.js"></script>
	<script charset="utf-8" src="http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/js/script.js"></script>

	<title>SHOKI JOETAKI OFFICIAL</title>
	<link rel="canonical" href="http://shokijoetaki.com">
</head>
<body>
...
<div class="under-ie9">
	<div class="under-ie9__inner">
		...
		<p>恐れ入りますが、ご利用のブラウザ(インターネット閲覧の為のソフト)は、古いバージョンのため本Webサイトではサポートしておりません。</p>
		<p>古いバージョンのブラウザでは、正常に表示されない場合があるため非表示となっております。<a href="http://browsehappy.com/">最新のバージョンへアップデート</a>してからご覧ください。</p>
	</div>
</div>
<![endif]-->
	...
	<header class="header" id="js-header">
		<div class="header__inner">
			<div class="header__logo">
				<a href="http://shokijoetaki.com/">
					<svg class="sj-logo"><title>SHOKI JOETAKI</title><use xlink:href="#sjLogo"/></svg>
				</a>
			</div>
			...
			<div class="header__nav h-nav">
				<nav class="h-nav__inner">
					<ul class="h-nav__list" id="js-nav">
						<li><a href="http://shokijoetaki.com/collections/">Collections</a></li>
						<li><a href="http://shokijoetaki.com/about/">About</a></li>
						<li><a href="http://shokijoetaki.com/stockists/">Stockists</a></li>
						<li><a href="http://shokijoetaki.com/news/">News</a></li>
						<li><a href="http://shokijoetaki.com/contact/">Contact</a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<main class="contents front-page" id="js-main">
		<section class="contents__above top-page" id="js-above">
			<div class="top-page__logo" id="js-top-logo">
				<p><img src="http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/images/front-page/sj-logo-w.svg" alt="SHOKI JOETAKI"></p>
			</div>
			<div class="top-page__btn" id="js-top-btn">
				<p><a href="http://shokijoetaki.com/entry-collections/41" id="js-text">NEWCOLLECTIONS</a></p>
			</div>
			<div class="top-page__slide" id="js-top-slide">
				<div class="top-page__bg slides" style="background-image:url(http://shokijoetaki.com/wordpress/wp-content/uploads/2016/01/cropped-sj-slider_01.jpg);"></div>
				<div class="top-page__bg slides" style="background-image:url(http://shokijoetaki.com/wordpress/wp-content/uploads/2016/01/cropped-sj-slider_02.jpg);"></div>
				<div class="top-page__bg slides" style="background-image:url(http://shokijoetaki.com/wordpress/wp-content/uploads/2016/01/cropped-sj-slider_03.jpg);"></div>
			</div>
			<div class="top-page__bg--filter"></div>
			<div class="top-page__info ticker is-visible" id="js-ticker">
				<p class="ticker__inner slides"><a href="http://shokijoetaki.com/entry-news/258"><span>2016.06.02</span>BLOG更新</a></p>
				<p class="ticker__inner slides"><a href="http://shokijoetaki.com/entry-news/249"><span>2016.05.17</span>SWG NAGOYAで受注会を行います。</a></p>
		...
		<div class="footer__inner">
			<div class="footer__icons">
				<div class="footer__share">
					<svg class="icons--share"><use xlink:href="#shareIcon"/></svg>
				</div>
				<div class="footer__sns icons">
					<div class="icons__inner"><a href="https://twitter.com/SHOKIJOETAKI" target="_blank"><svg class="icons--twitter"><use xlink:href="#twitterIcon"/></svg></a></div>
					<div class="icons__inner"><a href="https://www.facebook.com/shokijoetaki" target="_blank"><svg class="icons--facebook"><use xlink:href="#facebookIcon"/></svg></a></div>
					<div class="icons__inner"><a href="https://www.instagram.com/SHOKIJOETAKIOFFICIAL/" target="_blank"><svg class="icons--instagram"><use xlink:href="#instagramIcon"/></svg></a></div>
				</div>
			</div>
			<div class="footer__menu">
				<p><a href="http://shokijoetaki.com/blog/">Blog</a></p>
				<p><a href="http://shokijoetaki.com/media/">Media</a></p>
			</div>
		</div>
		<div class="footer__inner">
			<p class="footer__copy">&copy; SHOKI JOETAKI</p>
		</div>
	</footer>
...
<div class="modal" id="js-modal">
	<div class="modal__inner">
		<ul class="modal__list" id="js-modal-li">
			<li class="cur"><a href="http://shokijoetaki.com/"><span>Home</span></a></li>
			<li><a href="http://shokijoetaki.com/collections/"><span>Collections</span></a></li>
			<li><a href="http://shokijoetaki.com/about/"><span>About</span></a></li>
			<li><a href="http://shokijoetaki.com/stockists/"><span>Stockists</span></a></li>
			<li><a href="http://shokijoetaki.com/news/"><span>News</span></a></li>
			<li><a href="http://shokijoetaki.com/blog/"><span>Blog</span></a></li>
			<li><a href="http://shokijoetaki.com/media/"><span>Media</span></a></li>
			<li><a href="http://shokijoetaki.com/contact/"><span>Contact</span></a></li>
		</ul>
		<div class="modal__sns icons">
			<a href="https://twitter.com/SHOKIJOETAKI" target="_blank" class="icons__inner"><svg class="icons--twitter"><use xlink:href="#twitterIcon"/></svg></a>
			<a href="https://www.facebook.com/shokijoetaki" target="_blank" class="icons__inner"><svg class="icons--facebook"><use xlink:href="#facebookIcon"/></svg></a>
			<a href="https://www.instagram.com/SHOKIJOETAKIOFFICIAL/" target="_blank" class="icons__inner"><svg class="icons--instagram"><use xlink:href="#instagramIcon"/></svg></a>
		</div>
	</div>
</div>
