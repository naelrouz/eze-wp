!function () {
    function e() {
        ...
        p.id = "js-video",
            ...
            u.setAttribute("type", "video/webm"), v.setAttribute("src", "http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/video/logo-anim.mp4"),
            v.setAttribute("type", "video/mp4"), f.setAttribute("src", "http://shokijoetaki.com/wordpress/wp-content/themes/shokijoetaki/assets/images/common/sj-logo.svg"),
            h.appendChild(f),
            p.appendChild(u),
            p.appendChild(v),
            p.appendChild(h),
