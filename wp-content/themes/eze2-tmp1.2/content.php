...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div>
		...
		<div class="entry-content">
			1<?php the_content(__('Read more', 'portfolio')); ?>
			2<?php wp_link_pages(array('before' => '<div class="page-links"><span class="page-links-title">' . __('Pages:', 'portfolio') . '</span>', 'after' => '</div>', 'link_before' => '<span>', 'link_after' => '</span>')); ?>
			3<?php
